(function game2() {
  ...
  //Audio
  let winSound1 = new Audio('game_1.mp3');
  let roundSound1 = new Audio('roundPlayer_1.m4a');
  let roundSound2 = new Audio('roundPlayer_2.m4a');
  let winSound2 = new Audio('game_2.mp3');
  ...
  btnRoll.addEventListener('click', function () {
    if (scorePlayer[`${activePlayer}`] === 3) {
      ...
      activePlayer === 0 ? winSound1.play() : winSound2.play();
    ...
    if (holdTheGame === 1) {
      if (number === 1) {
        ...
        if (scores[`${activePlayer}`] >= 25) {
          ...
          activePlayer === 0 ? roundSound1.play() : roundSound2.play();
          document.getElementById(
            'modal-restart'
